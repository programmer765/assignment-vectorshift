...
def create_integration_item_metadata_object(
    ...
    response_data=json.loads(json.dumps(response_json))
    parent_id = None if parent_id is None else parent_id + '_Base'
    integration_item_metadata = IntegrationItem(
        id=response_data.get('id', None) + '_' + item_type,
...
def fetch_items(
    ...
    if offset is not None:
        return fetch_items(access_token, url, aggregated_response, offset)
